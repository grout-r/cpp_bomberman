...
public:
  ...
  bool initialize()
  {
    ...
    // La projection de la camera correspond a la maniere dont les objets vont etre dessine al'ecran
...
w// Mise a jour des inputs et de l'horloge de jeu
 ...
 return true;
  ...
  void draw()
  {
    ...
    // pour utiliser un shader (pour que ce soit ce dernier qui dessine la geometrie) il faut lebinder.
